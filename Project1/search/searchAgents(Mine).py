...
#------------------Start Q5-----------------------------------------------------------------------------------------------------------------
    def getStartState(self):
        ...
        """
        "*** YOUR CODE HERE ***"
        cornerList = (self.corners[0], self.corners[1], self.corners[2], self.corners[3]) #gets start state and start corner (x,y form)
        return (self.startingPosition, cornerList) #returns it
